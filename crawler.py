...
if response.status_code == 200:
    ...
    with open("computer_scientists_names.txt", "w", encoding="utf-8") as names_file, \
         open("computer_scientists_hrefs.txt", "w", encoding="utf-8") as hrefs_file:
    ...
    print("Data has been scraped and saved to computer_scientists_names.txt and computer_scientists_hrefs.txt.")
else:
